...
export const FamilyMemberNode = memo(({ data }: FamilyMemberNodeProps) => {
  ...
  return (
    <div className="nodrag">
      ...
      <div
        style={{ width: '280px' }}
        className={`${config.cardBg} rounded-xl shadow-xs border-l-4 ${config.accentBorder} p-3.5 text-slate-800 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 border border-[var(--color-brand-border)] ${
